...
def test_3_3(answer):
    ...
    assert sorted(list(answer.keys())) == ['mape_scorer','neg_mean_absolute_error','neg_mean_squared_error','neg_root_mean_squared_error','r2'], "Your dictionary is missing some keys. Make sure you are adding all the metrics."
...
def test_3_4(answer):
    ...
    assert answer['test_neg_root_mean_squared_error'].sum().round(0) == -44.0, "The range of your test negative root mean squared error is incorrect. Are you fitting the model properly?"
    assert answer['train_neg_root_mean_squared_error'].sum().round(0) == -44.0, "The range of your training negative root mean squared error is incorrect. Are you fitting the model properly?"
