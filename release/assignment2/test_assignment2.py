...
def test_2_4(answer):
    assert isinstance(answer, graphviz.sources.Source), "Make sure you are creating a graphviz object of the columns and the decision tree."
    return("Success")
...
def test_3_3(answer1,answer2,answer3):
    assert isinstance(answer2, altair.vegalite.v5.api.VConcatChart), "the panel object should be instance of `altair` contatinated chart"
    ...
    assert str(set([type(value) for value in answer3.values()])) == "{<class 'altair.vegalite.v5.api.Chart'>}", "Each figure in the dictionary needs to be of type 'altair.vegalite.v5.api.Chart'"
    return("Success")
...
def test_4_2(answer):
    ...
    assert sha1(str(res).encode('utf8')).hexdigest() == "2124e9920c9931f82236ed22093dfeba626bd38b", "Your answer contains incorrect values. Are you fitting the models properly?"
    return("Success")
